...
<head>
  ...
  <title>PENGURUSAN-INCENTIVE-MUATTURUN</title>
...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="navbar">
        ...
        <ul class="navbar2">
          <li><a class="selected" href="">Muat Turun Borang Pemohon</a></li>
        </ul>
 ...
 <div class="top-navigation">
  ...
  <a class="navtitle">>> Muat Turun Borang Pemohon</a>
...
<div class="content"><br><br>
  <button class="selected-form">HALAMAN MUAT TURUN</button><br><br><br>
  ...
  <input type="button" onclick="location.href='IncentiveManageMenu.php';" value="KEMBALI" class="kiri-button">
    <input type="button" onclick="" value="MUAT TURUN" class="kanan-button">
