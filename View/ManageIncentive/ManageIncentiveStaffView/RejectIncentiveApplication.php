...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="navbar">
        ...
        <ul class="navbar2">
          <li><a class="selected" href="">Tolak Permohonan</a></li>
        </ul>
 ...
 <div class="top-navigation">
  ...
  <a class="navtitle">>> Tolak Permohonan</a>
...
<div class="content"><br><br>
  ...
  <action="" method="POST"><br><br>
    <table class="listtable">
      ...
      <br><br><br>
      <button class="selected-form">SEBAB MENOLAK</button><br><br><br>
      <div class="form-group">
        <textarea id="message" name="message" placeholder="Taip Disini..."></textarea>
      </div>
      <div class="form-group">
