...
<head>
  ...
  <title>PENGURUSAN-INCENTIVE-SUNTING</title>
...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="navbar">
        ...
        <ul class="navbar2">
          <li><a class="selected" href="">Sunting Maklumat</a></li>
        </ul>
 ...
 <div class="top-navigation">
  ...
  <a class="navtitle">>> Sunting Borang Pemohon</a>
...
<div class="content"><br><br>
  <button class="selected-form">HALAMAN SUNTING</button><br><br><br>
  ...
  <table class="listtable">
    ...
    <tr>
        ...
        <td class="button-cell">
          <button class="edit" onclick="">SUNTING </button>
        </td>
    </tr>
    <tr>
        <td>2</td>
